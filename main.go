...
var (
	ccertFile = flag.String("consulcert", "/etc/consul.d/pki/tls/certs/consul-cli.pem", "A PEM eoncoded consul certificate file.")
	ckeyFile  = flag.String("consulkey", "/etc/consul.d/pki/tls/private/consul-cli-key.pem", "A PEM encoded consul private key file.")
